...
int[] lastLayerPermutation_2(){
 ...
 /* if((cube[0].x==1)&&(cube[0].z==1)){
  ...
  if((cube[2].x==-1)&&(cube[2].z==1)){
  if((cube[9].x==1)&&(cube[9].z==0)){
  if((cube[11].x==-1)&&(cube[11].z==0)){  //caso strano per risolvere 109 poi 113
  if((cube[18].x==1)&&(cube[18].z==-1)){
  if((cube[1].x==0)&&(cube[1].z==-1)){
  if((cube[20].x==-1)&&(cube[20].z==-1)){
      int[] temp = {5, 2, 5, 3, 10, 5, 11, 11, 3, 10, 2, 10, 4, 11, 4, 4, 3, 4, 2, 4, 2, 4, 3, 5, 3, 4, 4};
      pll = temp;
  }}}}}}}}
  if((cube[18].x==1)&&(cube[18].z==1)){
  if((cube[9].x==0)&&(cube[9].z==1)){
  if((cube[0].x==-1)&&(cube[0].z==1)){
  if((cube[1].x==1)&&(cube[1].z==0)){
  if((cube[19].x==-1)&&(cube[19].z==0)){  //caso strano' per risolvere 109 poi 113
  if((cube[20].x==1)&&(cube[20].z==-1)){
  if((cube[11].x==0)&&(cube[11].z==-1)){
  if((cube[2].x==-1)&&(cube[2].z==-1)){
      int[] temp = {3, 5, 2, 5, 3, 10, 5, 11, 11, 3, 10, 2, 10, 4, 11, 4, 4, 3, 4, 2, 4, 2, 4, 3, 5, 3, 4, 4};
      pll = temp;
  }}}}}}}}
  if((cube[20].x==1)&&(cube[20].z==1)){
  if((cube[1].x==0)&&(cube[1].z==1)){
  if((cube[18].x==-1)&&(cube[18].z==1)){
  if((cube[11].x==1)&&(cube[11].z==0)){
  if((cube[9].x==-1)&&(cube[9].z==0)){  //caso strano'' per risolvere 109 poi 113
  if((cube[2].x==1)&&(cube[2].z==-1)){
  if((cube[19].x==0)&&(cube[19].z==-1)){
  if((cube[0].x==-1)&&(cube[0].z==-1)){
      int[] temp = {3, 3, 5, 2, 5, 3, 10, 5, 11, 11, 3, 10, 2, 10, 4, 11, 4, 4, 3, 4, 2, 4, 2, 4, 3, 5, 3, 4, 4};
      pll = temp;
  }}}}}}}}*/
