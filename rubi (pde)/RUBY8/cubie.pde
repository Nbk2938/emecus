...
class cubie {
  ...
  cubie(PMatrix3D m, int x, int y, int z) { // costruttore dei 27 cubetti. la loro posizione é raffigurata da una propria matrice3D 
    ...
    faces[0] = new Face( new PVector(0, 0, -1), color (0, 255, 51));     //verde (dietro)(0, 255, 51)
    faces[1] = new Face( new PVector(0, 0, 1), color (0, 0, 255));       //blu (davanti)(0, 0, 255)
    faces[2] = new Face( new PVector(0, 1, 0), color (255, 255, 255));   //bianco (sopra)(255, 255, 255 )
    faces[3] = new Face( new PVector(0, -1, 0), color (255, 255, 0));    //giallo (sotto)(255, 255, 0)
    faces[4] = new Face( new PVector(1, 0, 0), color (255, 0, 0));       //rosso (destra)(255, 0, 0)
    faces[5] = new Face( new PVector(-1, 0, 0), color (255, 150, 0));    //arancio (sinistra)(255, 150, 0)
