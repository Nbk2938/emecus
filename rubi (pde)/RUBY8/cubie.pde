...
class cubie {
  ...
  cubie(PMatrix3D m, int x, int y, int z) { //cubie constructor
    ...
    faces[0] = new Face( new PVector(0, 0, -1), color (0, 255, 51));     //green (behind)(0, 255, 51)
    faces[1] = new Face( new PVector(0, 0, 1), color (0, 0, 255));       //blue (front)(0, 0, 255)
    faces[2] = new Face( new PVector(0, 1, 0), color (255, 255, 255));   //white (up)(255, 255, 255 )
    faces[3] = new Face( new PVector(0, -1, 0), color (255, 255, 0));    //jellow (down)(255, 255, 0)
    faces[4] = new Face( new PVector(1, 0, 0), color (255, 0, 0));       //red (right)(255, 0, 0)
    faces[5] = new Face( new PVector(-1, 0, 0), color (255, 150, 0));    //orange (left)(255, 150, 0)
