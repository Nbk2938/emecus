...
void keyPressed() {                    // interface per l'operatore.
  ...
  if (key == ' '){
    if(spacePressed != true){
      ...
      println(" ");
      //println("scrambled array sent to ardino (check green led)");
  ...
  if (key == 's'){   // quando sciaccio 's' aggiugo la soluzione alla sequenza.
    if(keySPressed != true){
      if(startSolution){
        ...
        //println(sequence);
        //println(" ");
        //println("solution array sent to ardino (check green led)");
   ...
   switch(key)     // implementazione di tutti singoli movimenti e aggiunta alla sequenza
   {
     case 'f':     
     sequence.add(f); currentMove.start(); 
     break;
     case 'F': 
     sequence.add(F); currentMove.start();
     break;
     case 'b': 
     sequence.add(b); currentMove.start();
     break;
     case 'B': 
     sequence.add(B); currentMove.start();
     break;
     case 'u': 
     sequence.add(u); currentMove.start();
     break;
     case 'U': 
     sequence.add(U); currentMove.start();
     break;
     case 'd': 
     sequence.add(d); currentMove.start();
     break;
     case 'D':
     sequence.add(D); currentMove.start();
     break;
     case 'l':
     sequence.add(l); currentMove.start();
     break;
     case 'L': 
     sequence.add(L); currentMove.start();
     break;
     case 'r': 
     sequence.add(r); currentMove.start();
     break;
     case 'R': 
     sequence.add(R);currentMove.start();
     break;
